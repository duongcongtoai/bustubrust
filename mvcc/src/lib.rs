...
pub trait TxManager {
    ...
    // transaction.
    // this function is called by update/delete executors.
    fn is_ownable(tx: Tx, tuple_id: u64) -> bool {
        false
    }

    // get write lock on a tuple.
    // this is invoked by update/delete executors.
    fn acquire_ownership(tx: Tx, tuple_id: u64) -> bool {
        false
    }
    ...
    fn yield_ownership(tx: Tx, tuple_id: u64) {}
